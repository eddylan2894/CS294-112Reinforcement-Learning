...
class ModelBasedRL(object):
    ...
    def _train_policy(self, dataset):
        ...
        for _ in range(self._training_epochs):
            # states[indices], actions[indices], next_states[indices], rewards[indices], dones[indices]
            for s, a, ns, _ , _ in dataset.random_iterator(self._training_batch_size):
                losses.append( self._policy.train_step( s, a, ns) )
