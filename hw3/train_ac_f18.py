...
class Agent(object):
    ...
    def get_log_prob(self, policy_parameters, sy_ac_na):
        ...
        if self.discrete:
            sy_logits_na = policy_parameters
            # YOUR_HW2 CODE_HERE
            sy_logprob_n = sy_logits_na = policy_parameters
            # YOUR_CODE_HERE
    ...
    def update_critic(self, ob_no, next_ob_no, re_n, terminal_n):
        ...
        for __ in range(self.num_target_updates):
            V_tp1 = self.sess.run(self.critic_prediction, feed_dict={ self.sy_ob_no : next_ob_no})
            #print("V shape= "+str(V_tp1.shape))
            # set the last one zero
            V_tp1 = V_tp1 * (1 - terminal_n)
            target = re_n + self.gamma * V_tp1
            for ___ in range(self.num_grad_steps_per_target_update):
...
def train_AC(
    ...
    for itr in range(n_iter):
        ...
        # YOUR CODE HERE
        #raise NotImplementedError
        agent.update_critic(ob_no=ob_no, next_ob_no=next_ob_no, re_n=re_n, terminal_n=terminal_n)
